...
- Prefer Instructions access via an Instruction button on Transform that opens `/instructions/:operation` for the current operation only; keep Instructions out of the main nav.
